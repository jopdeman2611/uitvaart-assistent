...
def api_haal_eerbetoon_data(naam_dierbare: str):
    ...
    try:
        ...
        r = requests.post(BASE44_API_URL, json=payload, headers=headers, timeout=10)
...
# ✅ Naam uit URL ophalen + netjes maken
query_params = st.query_params
eerbetoon_raw = query_params.get("eerbetoon", [""])[0]
naam_dierbare = " ".join(eerbetoon_raw.split())  # verwijdert rare spaties

# ❗ Slechts één API call
